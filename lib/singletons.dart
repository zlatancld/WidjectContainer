...
class Singletons {
  ...
  getOrAdd(Registration registration, DependencyProvider dependencyProvider, Key? key, dynamic args){
    var instance = _instances[registration];
    instance ??= _addInstance(registration, dependencyProvider, key, args);
    return instance;
  }

  _addInstance(Registration registration, DependencyProvider dependencyProvider, Key? key, dynamic args) {
